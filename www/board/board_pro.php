<?
	...
	if($mode=="write"){
		...
		$field['userno']	=$_SESSION['USER']['LOGIN_NO'];
	...
	if($mode=="reply"){
		...
		move_page("board_list.php?b_id=$b_id&b_code=$_POST[b_code]&page=$_POST[page]&search_key=$_POST[search_key]&search_val=$_POST[search_val]&page=$page");
	}
