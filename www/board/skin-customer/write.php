			...
			<div id="container" class="sub board write">
				...
				<input type="hidden" name="redirect" value="board_write.php?b_id=008&mode=write" />
							...
							<li>
								...
								<?
										...
										foreach($cateArr as $ckey=>$cval){
											$sel=((string)$b_code==(string)$cval ? "checked" : "");
											echo "<label><input type='radio' id='' name='b_code' value='$cval' $sel><em></em><p>$cval</p></label>";
										}
								?>
								</span>
							</li>
