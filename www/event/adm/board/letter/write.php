				...
				<div class="content">
					...
					<div class="tableStyle2">
						<table>
							...
							<tr>
								<th>pno</th>
								<td><input type="text" name="pno" id="pno" class="dInput req" title="pno" value="<?=$pList[pno]?>" /></td>
							</tr>
							<tr>
								<th>letterType</th>
								<td><input type="text" name="letterType" id="letterType" class="dInput req" title="letterType" value="<?=$pList[letterType]?>" /></td>
							</tr>
							<tr>
								<th>to_name</th>
								<td><input type="text" name="to_name" id="to_name" class="dInput req" title="to_name" value="<?=$pList[to_name]?>" /></td>
							</tr>
							<tr>
								<th>from_name</th>
								<td><input type="text" name="from_name" id="from_name" class="dInput req" title="from_name" value="<?=$pList[from_name]?>" /></td>
							</tr>
							<tr>
								<th>내용</th>
